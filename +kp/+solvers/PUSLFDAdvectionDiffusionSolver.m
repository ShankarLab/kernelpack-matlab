classdef PUSLFDAdvectionDiffusionSolver < handle
    %PUSLFDADVECTIONDIFFUSIONSOLVER PU-SL transport coupled with FD diffusion.
    ...
    methods
        function init(obj, domain, xi_sl, xi_fd, dt, nu, direction, num_omp_threads)
