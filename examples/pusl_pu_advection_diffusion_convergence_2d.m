function results = pusl_pu_advection_diffusion_convergence_2d()
%PUSL_PU_ADVECTION_DIFFUSION_CONVERGENCE_2D Convergence study for PU-SL + PU diffusion.
...
save('pusl_pu_advection_diffusion_convergence_2d_results.mat', 'results');
end
...
fprintf('\n2D PU-SL + PU diffusion convergence study\n');
