function results = pusl_pu_advection_diffusion_reaction_convergence_2d()
%PUSL_PU_ADVECTION_DIFFUSION_REACTION_CONVERGENCE_2D Convergence study for PU-SL + PU diffusion + reaction.
...
save('pusl_pu_advection_diffusion_reaction_convergence_2d_results.mat', 'results');
end
...
fprintf('\n2D PU-SL + PU diffusion + reaction convergence study\n');
