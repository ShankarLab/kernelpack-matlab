function results = pusl_fd_advection_diffusion_convergence_2d()
%PUSL_FD_ADVECTION_DIFFUSION_CONVERGENCE_2D Convergence study for PU-SL + FD diffusion.
...
fprintf('\n2D PU-SL + FD diffusion convergence study\n');
